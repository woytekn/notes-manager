...
import NoteEdit from './components/NoteEdit'; // Dodaj nowy komponent
      ...
      <div className="bg-gray-100 min-h-screen p-4">
        <div className="container mx-auto">
          <Routes>
            ...
            <Route path="/notes/:id" element={<NoteDetail notes={notes} deleteNote={deleteNote} />} />
            <Route path="/notes/:id/edit" element={<NoteEdit notes={notes} updateNote={updateNote} />} />
          </Routes>
        </div>
      </div>
    </Router>
